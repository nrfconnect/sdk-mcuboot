...
MCUboot is operating system and hardware independent and relies on hardware porting layers from the operating.
...
For more information in the source, see the following pointers:
