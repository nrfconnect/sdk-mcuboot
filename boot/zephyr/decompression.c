...
int bootutil_img_hash_decompress(struct boot_loader_state *state, struct image_header *hdr,
...
#ifdef MCUBOOT_ENC_IMAGES
    rc = compression_lzma->init(NULL, comp_size);
    rc = compression_arm_thumb->init(NULL, comp_size);
#else
