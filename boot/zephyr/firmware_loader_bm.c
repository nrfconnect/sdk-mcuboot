...
boot_go(struct boot_rsp *rsp)
{
    ...
    if (liteinstalls_isvalid()) {
        ...
        rc = liteinstalls_get_image_data(BM_INSTALLS_IMAGE_INDEX_SOFTDEVICE, &start_address,
                                         &image_size);
...
invalid_softdevice:
        ...
        start_address = 0;
        image_size = 0;
        rc = liteinstalls_get_image_data(BM_INSTALLS_IMAGE_INDEX_FIRMWARE_LOADER, &start_address,
                                         &image_size);
