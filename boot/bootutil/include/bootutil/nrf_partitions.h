...
#define NSIB_S1_CONTAINER_NODE DT_GPARENT(DT_NODELABEL(boot_partition_slot1))
#define NSIB_S1_SIZE DT_REG_SIZE(DT_NODELABEL(boot_partition_slot1))
#define NSIB_S1_ID FIXED_PARTITION_ID(boot_partition_slot1)
#define NSIB_S1_CONTAINER_ADDRESS DT_REG_ADDR(NSIB_S1_CONTAINER_NODE)
#define NSIB_S1_OFFSET DT_REG_ADDR(DT_NODELABEL(boot_partition_slot1))
