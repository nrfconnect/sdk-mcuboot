...
#define BOOT_REQUEST_SLOT_MAX_N (BOOT_REQUEST_PER_IMAGE * CONFIG_UPDATEABLE_IMAGE_NUMBER + 1)
...
#endif /* CONFIG_BOOT_SERIAL_BOOT_REQ */
...
#endif /* CONFIG_BOOT_FIRMWARE_LOADER_BOOT_REQ */
