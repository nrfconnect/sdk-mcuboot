...
enum boot_request_entry {
	...
	BOOT_REQUEST_ENTRY_PRIMARY_IMG_PREFERENCE = 1,
	BOOT_REQUEST_ENTRY_PRIMARY_IMG_CONFIRM = 2,
	BOOT_REQUEST_ENTRY_SECONDARY_IMG_PREFERENCE = 3,
	BOOT_REQUEST_ENTRY_SECONDARY_IMG_CONFIRM = 4,
				   ...
				   size_t *entry)
{
	...
	case BOOT_REQUEST_IMG_PREFERENCE:
		...
		case BOOT_REQUEST_SLOT_PRIMARY:
			*entry = BOOT_REQUEST_ENTRY_PRIMARY_IMG_PREFERENCE;
			break;
		case BOOT_REQUEST_SLOT_SECONDARY:
			*entry = BOOT_REQUEST_ENTRY_SECONDARY_IMG_PREFERENCE;
			break;
		default:
			return -EINVAL;
		}
	...
	case BOOT_REQUEST_IMG_CONFIRM:
		switch (image) {
		case BOOT_REQUEST_SLOT_PRIMARY:
			*entry = BOOT_REQUEST_ENTRY_PRIMARY_IMG_CONFIRM;
			break;
		case BOOT_REQUEST_SLOT_SECONDARY:
			*entry = BOOT_REQUEST_ENTRY_SECONDARY_IMG_CONFIRM;
			break;
		default:
			return -EINVAL;
		}
